...
class Constant2D : public aContiBlock2D {
 ...
 public:
  ...
  virtual Value2D Value() override  { return value; }      // without Eval
};
...
class Variable2D : public aContiBlock2D {
 ...
 public:
  ...
  // TODO: operator=
  virtual Value2D Value() override  { return value; }
};
...
struct Expression2D : public aContiBlock2D1 {
  ...
  Value2D Value() override { return InputValue(); }
};
...
class Integrator2D : public aContiBlock2D {
  ...
  class special_input : public aContiBlock {
   ...
   public:
    ...
    double Value() override;             // expects 2 subsequent evaluations
 ...
 public:
  ...
  virtual Value2D Value() override;      // 2D output
};
